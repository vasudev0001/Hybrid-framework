...
public class ExtentReportNG {
	...
	public static ExtentReports setupExtentReport() throws Exception {
		...
		String browser = System.getProperty("browser")!=null? System.getProperty("browser"):PropertiesOperations.getPropertyValueByKey("browser");
		extent.setSystemInfo("Executed on Environment: ", PropertiesOperations.getPropertyValueByKey("url"));
		extent.setSystemInfo("Executed on Browser: ", browser);// PropertiesOperations.getPropertyValueByKey("browser")
